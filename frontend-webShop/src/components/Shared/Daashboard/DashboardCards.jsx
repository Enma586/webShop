  ...
  return (
    <section className="w-full max-w-400 mx-auto px-12 mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
      <div className="bg-card border-l-12 border-primary p-10 shadow-sm border-y border-r">
        <span className="text-[10px] font-black text-primary/60 uppercase tracking-[0.3em] block mb-4">Gross Revenue Selected</span>
      ...
      <div className="md:col-span-2 bg-card border border-border p-10 shadow-sm flex flex-col justify-center">
        <span className="text-[10px] font-black text-primary/60 uppercase tracking-[0.3em] block mb-6">Top Moving Assets</span>
...
export const RevenueStream = ({ data }) => (
  <div className="lg:col-span-2 bg-card border border-border p-10 shadow-2xl relative overflow-hidden">
    <h3 className="text-xs font-black uppercase tracking-[0.3em] text-primary mb-12 border-b border-border pb-6">Revenue Stream Dynamic</h3>
  ...
  return (
    <div className="bg-card border border-border flex flex-col shadow-xl">
      <div className="p-8 border-b border-border bg-muted/5">
        <h3 className="text-[10px] font-black uppercase tracking-[0.4em] text-foreground">Filtered Transactions</h3>
      </div>
      <div className="flex-1 overflow-y-auto max-h-120 custom-scrollbar">
        ...
        )) : <div className="p-12 text-center text-[10px] font-black uppercase text-muted-foreground tracking-widest">No Data In Range</div>}
      </div>
    </div>
  );
};