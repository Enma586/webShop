...
import { Eye, EyeOff, Loader2, Fingerprint, ChevronLeft, UserPlus } from "lucide-react";
...
export default function RegisterPage() {
    ...
    <div className="min-h-screen w-full bg-background flex items-center justify-center p-4 md:p-8 font-sans antialiased transition-colors duration-500">
        ...
        {/* Contenedor Principal: Bordes Rectos y Sombra Esmeralda */}
        <div className="bg-card w-full max-w-6xl overflow-hidden shadow-[0_0_50px_-12px_rgba(var(--primary),0.2)] flex flex-col lg:flex-row min-h-650px border border-primary/30">
                ...
                <form onSubmit={onSubmit} className="space-y-4">
                    ...
                    <div className="space-y-1.5">
                        ...
                        <Input
                            ...
                            className="rounded-none border-primary/20 bg-primary/5 h-11 focus-visible:ring-1 focus-visible:ring-primary transition-all placeholder:text-muted-foreground/30 text-xs"
                    ...
                    <div className="space-y-1.5">
                        ...
                        <div className="relative">
                            <Input
                                ...
                                className="rounded-none border-primary/20 bg-primary/5 h-11 pr-12 focus-visible:ring-1 focus-visible:ring-primary transition-all placeholder:text-muted-foreground/30 text-xs"
                                placeholder="••••••••"
                            />
                            <button
                                type="button"
            ...
            <div className="hidden lg:flex lg:w-[55%] relative bg-card overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-lineal-to-br from-primary/30 via-transparent to-transparent" />
