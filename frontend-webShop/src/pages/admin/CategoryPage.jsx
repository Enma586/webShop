  ...
  return (
    <div className="flex flex-col w-full bg-background min-h-screen">
      <section className="w-full max-w-1600px mx-auto pt-16 px-12">
        <UniversalHeader title="Categories" isAdmin={true} onActionClick={() => setIsModalOpen(true)} onRefresh={getCategories} searchTerm={searchTerm} setSearchTerm={setSearchTerm} />
      </section>
